              ...
              {editingId === rev.id ? (
                ...
                <div className="flex items-center gap-2 mt-0.5">
                  ...
                  <button
                    ...
                    className="shrink-0 inline-flex items-center gap-1 px-2 py-1 text-xs font-medium text-gray-600 bg-gray-100 border border-gray-200 rounded-md hover:bg-gray-200 hover:text-gray-900 transition-colors"
                  >
